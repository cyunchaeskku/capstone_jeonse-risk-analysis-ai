...
label 기준:
- core: 주택 임대차 보증금이 직접 쟁점이거나, 그 쟁점이 임차인의 보증금 회수 가능성 판단에 바로 쓰인다.
  보증금 반환, 대항력·우선변제권·확정일자, 임차권등기, 소액임차인 최우선변제,
  경매·배당에서 임차인의 지위, 임대차 기간·계약갱신요구권·묵시적 갱신·계약 해지,
  임대인 지위의 승계, 전세보증금 편취 사기, 깡통전세·갭투자,
  임대인·공인중개사의 설명의무와 손해배상책임, 신탁된 부동산의 임대 권한,
  임차인의 배당·보증금 회수에 영향을 주는 선순위 담보권의 범위가 여기 해당한다.
- related: 전세 위험 판단의 배경은 되지만 임차인의 지위를 직접 다루지 않는 법리다.
  임차인이 등장하지 않는 근저당권 설정·말소·채권최고액 일반 법리,
  사해행위취소, 채권자 사이의 배당순위, 명의신탁, 조세채권의 우선순위,
  사기죄의 기망행위나 고의 판단 기준, 상가 임대차가 여기 해당한다.
- unrelated: 그 외 전부.

판단 규칙:
- 요약은 길이 제한 때문에 중간에 잘려 있을 수 있다. 보이는 범위에서만 판단한다.
- **쓰인 용어가 아니라 쟁점으로 판단한다.** 판결문이 공인중개사법·신탁법·민법 일반론으로 서술되어
  '전세'나 '임대차'라는 말이 없어도, 쟁점이 core 목록에 닿으면 core다.
- core 목록에 닿으면 core로 둔다. 어디에도 안 닿을 때만 related를 쓴다.
  관련 없어 보이면 주저 말고 unrelated로 둔다.
